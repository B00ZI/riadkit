            ...
            <div className="flex gap-1.5 p-1 bg-secondary rounded-lg">
              {(["pending", "in_progress", "completed"] as const).map((s) => (
                <button
                  key={s}
                  onClick={() => setFilter(s)}
                  className={`px-3 py-1 rounded-md text-[10px] font-black uppercase transition-all ${filter === s
          ...
          <div className="space-y-2">
            {requests
              ...
              .map((order) => (
                ...
                >
                  {/* Top row: Room + Price + Status dot (optional) */}
                  <div className="flex items-center justify-between">
              ...
              {rooms.map((room) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div
                      className={`w-2.5 h-2.5 rounded-full ${room.status === "occupied"

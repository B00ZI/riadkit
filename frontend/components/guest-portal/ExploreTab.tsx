...
export const ExploreTab = ({ excursions, isExpired, onRequestItem }: ExploreTabProps) => (
      ...
      <div className="space-y-4">
        {excursions.map((item) => {
          ...
          return (
            <Card
              key={item.id}
              className={`p-4 bg-card border-border/80 rounded-2xl shadow-2xs transition-all space-y-3 ${
